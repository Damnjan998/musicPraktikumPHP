				...
				<div class='section group'>
					...
					<div class='grid_1_of_4 images_1_of_4'>
                        ...
                        foreach($rezultat as $rez){
							if($rez->naziv == "Export to WORD"){
								echo "<li>
										<a href='$rez->putanja'>$rez->naziv</a>
									</li>";
							} else if($rez->naziv == "Export to EXCEL"){
								echo "<li>
										<a href='$rez->putanja'>$rez->naziv</a>
									</li>";
							} else {
								echo "<li>
										<a href='data/$rez->putanja' target='_blank'>$rez->naziv</a>
                            		</li>";
							}							
                        };
						echo "</ul>
